...
CORRECTED: Uses local network URL for testing
"""
...
def create_emergency_qr_code(patient_id: int, emergency_token: str, base_url: str = "https://mias-patient-access.streamlit.app/Emergency_Access") -> Image:
    """
    ...
    Args:
        ...
        base_url: Base URL of the application (default: local network for testing)
        
    Returns:
        PIL Image object containing the QR code
        
    NOTE: For testing, uses local network URL (http://192.168.254.161:8504)
          For production, change to: "https://mias-license-to-live.streamlit.app"
    """
